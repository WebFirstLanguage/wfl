...
| --------------- | ------------------ | ----- |
| 26.4.x (Current)| ✅ Yes             | Active development, security fixes prioritized |
| 26.3.x         | ⚠️ Limited         | Critical security issues only |
| 26.2.x and older| ❌ No            | No security updates provided |
