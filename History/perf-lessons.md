# Performance Lessons (promoted from .jules/bolt.md)

Durable optimization lessons learned while tuning the WFL lexer, parser, and
interpreter. Promoted out of the Jules agent's working notes (`.jules/bolt.md`)
by the repository hygiene migration; non-normative history, preserved verbatim
below. New entries belong here, dated, appended at the end.
