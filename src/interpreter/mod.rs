    ...
    async fn _execute_statement(
        ...
        let result = match stmt {
            ...
            Statement::OpenFileStatement {
                ...
                let path_str = path_value.expect_text("file path", *line, *column)?.clone();
            ...
            Statement::ReadFileStatement {
                ...
                let path_str = path_value
                    .expect_text("file path or handle", *line, *column)?
                    .clone();
            ...
            Statement::WriteFileStatement {
                ...
                let file_str = file_value
                    .expect_text("file handle", *line, *column)?
                    .clone();

                let content_str = content_value
                    .expect_text("file content", *line, *column)?
                    .clone();
            ...
            Statement::CreateDirectoryStatement { path, line, column } => {
                let path_value = self.evaluate_expression(path, Rc::clone(&env)).await?;
                let path_str = path_value
                    .expect_text("directory path", *line, *column)?
                    .clone();
            ...
            Statement::HttpGetStatement {
                ...
                let url_str = url_val.expect_text("URL", *line, *column)?.clone();
            ...
            Statement::HttpPostStatement {
                ...
                let data_str = data_val.expect_text("data", *line, *column)?.clone();
