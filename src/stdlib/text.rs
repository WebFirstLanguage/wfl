...
pub fn register_text(env: &mut Environment) {
    ...
    let _ = env.define_native("touppercase", native_touppercase);
    let _ = env.define_native("tolowercase", native_tolowercase);
    let _ = env.define_native("substring", native_substring);
    let _ = env.define_native("string_split", native_string_split);

    let _ = env.define_native("to_uppercase", native_touppercase);
    let _ = env.define_native("to_lowercase", native_tolowercase);

    // New string manipulation functions
    let _ = env.define_native("trim", native_trim);
    let _ = env.define_native("starts_with", native_starts_with);
    let _ = env.define_native("ends_with", native_ends_with);

    // Aliases for split, startswith, endswith
    let _ = env.define_native("split", native_string_split);
    let _ = env.define_native("startswith", native_starts_with);
    let _ = env.define_native("endswith", native_ends_with);

    // New text manipulation functions
    let _ = env.define_native("replace", native_replace);
    let _ = env.define_native("last_index_of", native_last_index_of);
    let _ = env.define_native("lastindexof", native_last_index_of);
    let _ = env.define_native("padleft", native_padleft);
    let _ = env.define_native("padright", native_padright);
    let _ = env.define_native("capitalize", native_capitalize);
    let _ = env.define_native("reverse", native_reverse_text);
    let _ = env.define_native("reverse_text", native_reverse_text);

    // Query string and form parsing
    let _ = env.define_native("parse_query_string", native_parse_query_string);
    let _ = env.define_native("parse_cookies", native_parse_cookies);
    let _ = env.define_native("parse_form_urlencoded", native_parse_form_urlencoded);
}
