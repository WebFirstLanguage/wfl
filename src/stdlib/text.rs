...
fn parse_key_value_pairs(
    ...
    // Pre-allocate the HashMap using a heuristic to avoid costly reallocations.
    // URL-encoded key-value pairs are typically at least 4 characters long (e.g., "a=b&").
    let capacity = (input.len() / 4) + 1;
