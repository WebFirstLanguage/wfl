...
pub fn register_time(env: &mut Environment) {
    let _ = env.define_native("today", native_today);
    let _ = env.define_native("now", native_now);
    let _ = env.define_native("datetime_now", native_datetime_now);
    let _ = env.define_native("format_date", native_format_date);
    let _ = env.define_native("format_time", native_format_time);
    let _ = env.define_native("format_datetime", native_format_datetime);
    let _ = env.define_native("parse_date", native_parse_date);
    let _ = env.define_native("parse_time", native_parse_time);
    let _ = env.define_native("create_time", native_create_time);
    let _ = env.define_native("create_date", native_create_date);
    let _ = env.define_native("add_days", native_add_days);
    let _ = env.define_native("days_between", native_days_between);
    let _ = env.define_native("current_date", native_current_date);
}
