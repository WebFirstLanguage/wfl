...
pub fn register_random(env: &mut Environment) {
    let _ = env.define_native("random", native_random);
    let _ = env.define_native("random_between", native_random_between);
    let _ = env.define_native("random_int", native_random_int);
    let _ = env.define_native("random_boolean", native_random_boolean);
    let _ = env.define_native("random_from", native_random_from);
    let _ = env.define_native("random_seed", native_random_seed);
    let _ = env.define_native("generate_uuid", native_generate_uuid);
}
