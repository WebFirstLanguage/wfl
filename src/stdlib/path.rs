...
pub fn register_path(env: &mut Environment) {
    ...
    env.define("path_relpath", Value::NativeFunction("path_relpath", native_path_relpath));
    env.define("path_normalize", Value::NativeFunction("path_normalize", native_path_normalize));
}
