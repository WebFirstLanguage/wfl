...
pub fn register_math(env: &mut Environment) {
    let _ = env.define_native("abs", native_abs);
    let _ = env.define_native("round", native_round);
    let _ = env.define_native("floor", native_floor);
    let _ = env.define_native("ceil", native_ceil);
    let _ = env.define_native("clamp", native_clamp);
    let _ = env.define_native("min", native_min);
    let _ = env.define_native("max", native_max);
    let _ = env.define_native("power", native_power);
    let _ = env.define_native("sqrt", native_sqrt);
    let _ = env.define_native("sin", native_sin);
    let _ = env.define_native("cos", native_cos);
    let _ = env.define_native("tan", native_tan);
}
