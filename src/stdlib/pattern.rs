...
pub fn register(env: &mut Environment) {
    ...
    let _ = env.define_native("pattern_matches", pattern_matches_native);
    let _ = env.define_native("pattern_find", pattern_find_native);
    let _ = env.define_native("pattern_find_all", pattern_find_all_native);
