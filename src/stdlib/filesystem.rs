...
pub fn register_filesystem(env: &mut crate::interpreter::environment::Environment) {
    ...
    env.define_native("rglob", native_rglob);
    env.define_native("path_join", native_path_join);
    env.define_native("path_basename", native_path_basename);
    env.define_native("path_dirname", native_path_dirname);
    env.define_native("makedirs", native_makedirs);
    env.define_native("file_mtime", native_file_mtime);
    env.define_native("path_exists", native_path_exists);
    env.define_native("is_file", native_is_file);
    env.define_native("is_dir", native_is_dir);
    env.define_native("count_lines", native_count_lines);
    env.define_native("path_extension", native_path_extension);
    env.define_native("path_stem", native_path_stem);
