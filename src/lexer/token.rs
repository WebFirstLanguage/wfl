...
pub enum Token {
    ...
    #[regex("(?:yes|no|true|false)", |lex| {
        ...
        // The regex ensures input is one of yes, no, true, false (lowercase).
        // We include uppercase check to match intent of original code, though regex currently enforces lowercase.
