...
No deployment, remote push, CI run, Linux execution, or independent R3 review is
claimed. Clean Windows/Linux CI and independent review remain merge/release
gates; this record is local implementation evidence. Extension host tests are
not run: no VS Code extension code, dependencies, or protocol changes are made.
