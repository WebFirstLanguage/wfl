...
- **[Configuration Reference (`.wflcfg`)](reference/configuration-reference.md)** - **One-stop guide** for project config: all keys, defaults, CLI (`wfl config`, `--configCheck`, `--configFix`), lint/style, security, web server
